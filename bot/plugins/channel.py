    ...
    if update.from_user.id not in OWNER_ID:
        await bot.send_message(
           chat_id=update.chat.id,
            ...
            Only For <b><u><a href="https://t.me/movie_store02">Movies' Hub Channel</a></u></b></i>""".format(update.from_user.first_name),
            parse_mode="html",

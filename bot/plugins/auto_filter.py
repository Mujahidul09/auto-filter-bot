...
async def auto_filter(bot, update):
    ...
    if len(results) == 0:   # double check
        ...
        ibuttonss.append(
                        [
                            InlineKeyboardButton("⭕️ CONTACT ME ⭕️", url="https://t.me/mujahidul_09"),
                            InlineKeyboardButton("⚜ New Movies ⚜", url="https://t.me/movie_store02")
                        ]
                    )
        for x in ibuttonss:
                result[0].insert(0, x) #Insert invite link buttons at first of page
        ...
        try:
            await bot.send_photo( 
                chat_id=update.chat.id,
                photo="https://photos.app.goo.gl/2xw6Sdo3W29nmz5dA",

...
async def start(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('Developers', url='https://t.me/mujahidul_09')
    ],[
    ...
    if update.from_user.id not in OWNER_ID:
        await bot.send_message(
            ...
            text="""<b>Hey {}!!</b>
             <b><u><a href="https://t.me/movie_store02">Movies' Hub Channel</a></u></b> 🤭🤭""".format(update.from_user.first_name),
            parse_mode="html",
